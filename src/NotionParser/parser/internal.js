...
function parseRichText(root, options) {
  ...
  root.children.forEach((child) => {
    if (child.type === 'paragraph')
      ...
      (options === null || options === void 0 ? void 0 : options.nonInline) ===
      'throw'
    )
  ...
  return (
    truncate ? richTexts.slice(0, notion_1.LIMITS.RICH_TEXT_ARRAYS) : richTexts
  ).map((rt) => {
    var _a;
    ...
    if (
      ((_a = rt.text.link) === null || _a === void 0 ? void 0 : _a.url) &&
